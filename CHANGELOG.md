...
- **Added** claude: Write plainly and put pasteable text on a page ([`4e37c55`](https://github.com/davner/dotfiles/commit/4e37c5559d71399e718f16318ea1fbf40f06dd95))
- **Added** claude: Add a ship-pack skill to hand over ready branches ([`ca7c4c6`](https://github.com/davner/dotfiles/commit/ca7c4c6844bba5e6987f199b186ccd77a8ab98b8))
- **Docs** claude: Record PrimeReact Toast gotchas in the v10 skill ([`afac74e`](https://github.com/davner/dotfiles/commit/afac74ed235893f9fac67913f6cb152c51bbae96))
- **Added** claude: Start from library defaults and gate new dependencies ([`09c7bbc`](https://github.com/davner/dotfiles/commit/09c7bbca6e9242828cf47cf81aac56e3777596a7))
- **Added** claude: Hold tests to the project's rules and prove they fail ([`65e0c8f`](https://github.com/davner/dotfiles/commit/65e0c8f3babcc4b61fa0005ad2e13d89a2a7ce9c))
- **Added** claude: Route costly review fixes to the user and version specs ([`4841fb6`](https://github.com/davner/dotfiles/commit/4841fb602055828f60f10a9f6e652f4cd1c55d93))
- **Added** claude: Research prior art and list reader states in specs ([`180034b`](https://github.com/davner/dotfiles/commit/180034b89d2836e7c076ec0356cdcd1c1e697f19))
- **Added** claude: Track a ticket's base, port and server through close-out ([`c3c937d`](https://github.com/davner/dotfiles/commit/c3c937db210ea9768990b69443da7312d33524a1))
...
- **Added** claude: Lower the comment-run cap to two lines ([`736ca82`](https://github.com/davner/dotfiles/commit/736ca82e44ff41b23bd348d39146958a4172a4e4))
- **Fixed** darwin: Declare the claude-code@latest cask ([`064d91c`](https://github.com/davner/dotfiles/commit/064d91ca6a1003488bb785c0ef48f88bbd993d0a))

## 2026-09-22

- **Added** claude: Add a draft-ticket skill for the ticket loop's spec step ([`0eb0e49`](https://github.com/davner/dotfiles/commit/0eb0e49f8acfc20675366e48aa30869e30fde2e3))
- **Added** claude: Block AI commit credit from any vendor, not just Claude ([`b05f55d`](https://github.com/davner/dotfiles/commit/b05f55dff41bf0e678b3bdb7b660768fa63f0fab))
- **Added** claude: Block commits whose message breaks the subject or body cap ([`b172208`](https://github.com/davner/dotfiles/commit/b1722080d6cad5c3d5bea9cbc8d4bdb13e70b12a))
...
- **Added** ticket: Gate reviews on green tests and scope rounds to the new diff ([`7f0714f`](https://github.com/davner/dotfiles/commit/7f0714f80d56fb087c897ea13cf200e8e9b29047))
- **Added** claude: Add a /context-audit command with per-file size caps ([`2665f36`](https://github.com/davner/dotfiles/commit/2665f363b128c0e1c00cc448fa4bd4f2760c7fe8))
- **Added** claude: Flag session talk and month dates in the comment audit ([`3840750`](https://github.com/davner/dotfiles/commit/384075062db5352d8651c67c69c1161b5a73c251))

## 2026-09-11

- **Added** ticket: Time each phase and share one app in review ([`e601981`](https://github.com/davner/dotfiles/commit/e60198155255930c2151341da052a2adff0abb4d))

## 2026-09-10

- **Docs** agents: Carry the worktree lessons into the rules ([`c0b9d12`](https://github.com/davner/dotfiles/commit/c0b9d1247819d6de7b07a8fb915a85a9bf96e64f))
- **Added** claude: Enforce the absolute git rules with a hook ([`c7eea3f`](https://github.com/davner/dotfiles/commit/c7eea3f53809d11d91af72a4db184a4450940293))
- **Docs** Note that the claude-code cask lags upstream ([`8ce32b6`](https://github.com/davner/dotfiles/commit/8ce32b63d0efeff4cc2fd5fb166ab09efa6ce9d1))
