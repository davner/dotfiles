...
| `yt-dlp --tone RANGE URL` | `~/Documents/YouTube/Tones` | A trimmed clip, written as `.m4r` |
...
iOS will not install a tone from the Files app. Connect the iPhone to this Mac,
select it in the Finder sidebar, and drag the `.m4r` onto it. It then appears
under Settings > Sounds & Haptics, named after the file.
